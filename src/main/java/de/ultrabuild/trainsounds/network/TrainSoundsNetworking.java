...
import de.ultrabuild.trainsounds.client.ClientAnnounceHandler;
...
public class TrainSoundsNetworking {
    ...
    private static void registerPayloads(final RegisterPayloadHandlersEvent event) {
        ...
        registrar.playBidirectional(ToggleCarriageEngineC2SPacket.ID, ToggleCarriageEngineC2SPacket.STREAM_CODEC,
                (packet, context) -> {
        ...
        registrar.playBidirectional(OpenCarriageGuiS2CPacket.ID, OpenCarriageGuiS2CPacket.STREAM_CODEC,
                (packet, context) -> {
                    TrainSoundsClientHandler.handleOpenCarriageGuiPacket(packet);
                });

        // --- NOUVEAU CODE (Annonces Vocales) ---
        registrar.playToClient(
                TrainAnnouncePacket.TYPE,
                TrainAnnouncePacket.STREAM_CODEC,
                ClientAnnounceHandler::handle);
    }

    public static void sendOpenCarriageGuiPacket(ServerPlayer player,
            com.simibubi.create.content.trains.entity.CarriageContraptionEntity carriage) {
